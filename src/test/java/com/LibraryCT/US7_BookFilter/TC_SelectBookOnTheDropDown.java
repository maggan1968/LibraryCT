package com.LibraryCT.US7_BookFilter;
...
public class TC_SelectBookOnTheDropDown {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Users.add("librarian54@library");
        Users.add("librarian15@library");
        Users.add("student42@library");
        Users.add("student43@library");
        Users.add("student44@library");
