...
public class Student_Login_Positive {
    public static void main(String[] args) throws InterruptedException {
        ...
        studentUsers.add("student42@library");
        studentUsers.add("student43@library");
        studentUsers.add("student44@library");
        ...
        for (String eachstudentUser : studentUsers) {
            ...
            if (driver.getTitle().equalsIgnoreCase("Login - Library")) {
                System.out.println(eachstudentUser+" Page title is verify(Login - Library)");
            } else {
                System.out.println(eachstudentUser+" Page title is not verify");
            }
